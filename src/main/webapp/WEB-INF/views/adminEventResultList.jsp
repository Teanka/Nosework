            ...
            <table class="table table-hover">
                ...
                <c:forEach var="result" items="${containers}">
                    <tr>
                        ...
                        <td><a href="/admin/${result.event.id}/edit/${result.id}" class="btn btn-success">Edytuj</a></td>
                        <td><a href="/admin/${result.event.id}/delete/${result.id}" class="btn btn-danger">Usuń</a></td>
                    </tr>
                </c:forEach>
                </c:if>
